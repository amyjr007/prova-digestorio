# 2ª Avaliação de Ciências — E.E. Feliz Lusitânia

Prova objetiva de **Sistema Digestório, Nutrição e Energia**, feita para rodar
nos Chromebooks da escola. Instala como aplicativo (PWA), funciona sem internet
depois da primeira abertura e corrige a nota sozinha.
...
> Depois de alterar a prova, troque o número em `const CACHE = "prova-fl-v1"`
> no `sw.js`. É ele que descarta o pacote antigo e faz os Chromebooks já
> instalados baixarem a versão nova.
